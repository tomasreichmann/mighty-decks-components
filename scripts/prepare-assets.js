...
const manifest = JSON.parse(await readFile(resolve(packageRoot, "resources", "artwork-manifest.json"), "utf8"));
...
await writeFile(resolve(assetsRoot, "inventory.json"), `${JSON.stringify({ files: inventory }, null, 2)}\n`);
